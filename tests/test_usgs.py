...
class TestUsgsScraping(unittest.TestCase):
    def setUp(self):
        ...
        self.western_scraper = HydroScraper(datetime(2021, 12, 1), datetime(2022, 3, 1), 
                                            os.path.join(self.test_data_dir, "west_meta.json"))
    ...
    def test_snotel_west(self):
        ...
        # TODO figure out hour discrepancy while scraping..
